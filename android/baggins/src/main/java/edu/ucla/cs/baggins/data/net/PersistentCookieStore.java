...
public class PersistentCookieStore implements CookieStore {
     ...
     */
    private final static String PREF_SESSION_COOKIE = "connect.sid2";
    ...
    public PersistentCookieStore(Context context) {
        ...
        // postGetInserted the default in memory store and if there is a cookie stored in shared preferences,
